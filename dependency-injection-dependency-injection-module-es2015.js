...
BaseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
  ...
  `,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./base.component.css */ "./src/app/dependency-injection/base/base.component.css")).default]
    })
], BaseComponent);
...
/* harmony import */ var _base_base_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./base/base.component */ "./src/app/dependency-injection/base/base.component.ts");
...
let DependencyInjectionRoutingModule = class DependencyInjectionRoutingModule {
};
DependencyInjectionRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _dependency_injection_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dependency-injection-routing.module */ "./src/app/dependency-injection/dependency-injection-routing.module.ts");
/* harmony import */ var _base_base_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./base/base.component */ "./src/app/dependency-injection/base/base.component.ts");
/* harmony import */ var _form_new_user_form_new_user_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form-new-user/form-new-user.component */ "./src/app/dependency-injection/form-new-user/form-new-user.component.ts");
/* harmony import */ var _new_user_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./new-user.service */ "./src/app/dependency-injection/new-user.service.ts");
/* harmony import */ var _user_info_user_info_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./user-info/user-info.component */ "./src/app/dependency-injection/user-info/user-info.component.ts");
...
DependencyInjectionModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _base_base_component__WEBPACK_IMPORTED_MODULE_5__["BaseComponent"],
            _form_new_user_form_new_user_component__WEBPACK_IMPORTED_MODULE_6__["FormNewUserComponent"],
            _user_info_user_info_component__WEBPACK_IMPORTED_MODULE_8__["UserInfoComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"],
            _dependency_injection_routing_module__WEBPACK_IMPORTED_MODULE_4__["DependencyInjectionRoutingModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormNewUserComponent", function() { return FormNewUserComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _new_user_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../new-user.service */ "./src/app/dependency-injection/new-user.service.ts");



let FormNewUserComponent = class FormNewUserComponent {
...
FormNewUserComponent.ctorParameters = () => [
    { type: _new_user_service__WEBPACK_IMPORTED_MODULE_2__["NewUserService"] }
];
FormNewUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-form-new-user',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./form-new-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dependency-injection/form-new-user/form-new-user.component.html")).default,
        styles: ["\n  button[disabled] {\n    color: gray;\n  }\n  "]
    })
...
NewUserService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let UserInfoComponent = class UserInfoComponent {
    constructor(newUserService) {
        this.newUserService = newUserService;
        this.newUserService.getStream().subscribe(data => this.userInfo = data);
    }
};
...
UserInfoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./user-info.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/dependency-injection/user-info/user-info.component.html")).default,
